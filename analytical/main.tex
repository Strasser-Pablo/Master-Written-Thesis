...
$p$ is not the pressure but pressure divided by density, pressure is $\tilde{p}$:
\begin{equation}
 \tilde{p}=\frac{p}{\rho}
\end{equation}
Because in incompressible Navier-Stokes $\rho$ is constant this doesn't pose problem in derivative.
