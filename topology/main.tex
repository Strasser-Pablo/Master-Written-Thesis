...
\subcaptionbox{$t_2$, because the red point is now in the domain, the speed is given by the acceleration from the Navier-Stokes equation.\label{topo:mult_part_error:3}}{%
...
$t_{in}$ is the moment when particle $1$ enter in the new cell.$t_{f}$ is the moment when particle $2$ enter in the new cell.
...
For the none splitted case the acceleration is given by \ref{topo:equ:onediff}.
