...
In next subsection we will present an overview of the two methods.
...
We now need to choose a domain and boundary condition.
...
For speed we use the analytical solution (cf. equations \ref{fixed:vortex}) outside the domaine
